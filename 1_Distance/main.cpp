...
int main() {
    ...
    while(encoder0.get_cm()<112) {wait_us(50000); xbee.printf("Go Straight\r\n");} //Have try: 100
    ...
    // turn left //
    car.turn(100, +0.1); wait_us(1500000); xbee.printf("Turn left\r\n"); car.stop();
    encoder0.reset();
    GREEN = 0; car.goStraight(100);
    while(encoder0.get_cm()<15) {wait_us(50000);xbee.printf("Go Straight(enter Mission 1)\r\n");} // enter mission 1
    GREEN = 1; 
    
    car.turn(100, +0.1); wait_us(1500000); xbee.printf("Turn left\r\n"); car.stop();
    encoder0.reset();
    GREEN = 0; car.goStraight(100);
    while(encoder0.get_cm()<15) {wait_us(50000);xbee.printf("Go Straight\r\n");}
    GREEN = 1;
    
    car.turn(100, -0.1); wait_us(1500000); xbee.printf("Turn right\r\n"); car.stop();
    encoder0.reset();
    GREEN = 0; car.goStraight(100);
    while(encoder0.get_cm()<45) {wait_us(50000);xbee.printf("Go Straight\r\n");}
    GREEN = 1;

    car.turn(100, -0.1); wait_us(1500000); xbee.printf("Turn right(face to number)\r\n"); car.stop();
    ...
    // car into garage
    car.turn(-100, -0.1); wait_us(1500000); xbee.printf("Reverse right\r\n"); car.stop();
    encoder0.reset();
    GREEN = 0; car.goStraight(-100);
    while(encoder0.get_cm()<45) {wait_us(50000);xbee.printf("Go Reverse\r\n");}
    GREEN = 1;

    car.turn(-100, +0.3); wait_us(1500000); xbee.printf("Reverse into garage\r\n"); car.stop();wait_us(2000000);
    encoder0.reset();
    GREEN = 0; car.goStraight(100);
    ...
    car.turn(100, -0.1); wait_us(1500000); xbee.printf("Turn right(face to object)\r\n"); car.stop();
    ...
    // leave the region
    car.turn(-100, -0.1); wait_us(1500000); xbee.printf("Reverse right(face to exit)\r\n"); car.stop();
    encoder0.reset();
    GREEN = 0; car.goStraight(100);
